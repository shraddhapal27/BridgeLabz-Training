...
public class CsvCensor {
    public static void main(String[] args) {
        ...
        try {
            BufferedReader reader = new BufferedReader(new FileReader("src/main/resources/ipl.csv"));
            BufferedWriter writer = new BufferedWriter(new FileWriter("src/main/resources/censored_ipl.csv"));
